...
<body class="font-sans antialiased text-gray-800 dark:text-gray-200 dark:bg-gray-900 min-h-screen flex flex-col">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="annonces.html"
                        class="nav-link text-gray-600 dark:text-gray-300 hover:text-forest dark:hover:text-sunlight font-medium transition duration-300">Explorer
                        le matériel</a>
                    <a href="#devenir-partenaire"
                        class="nav-link text-gray-600 dark:text-gray-300 hover:text-forest dark:hover:text-sunlight font-medium transition duration-300">Devenir
                        Partenaire</a>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative">
                                ...
                                <div id="notifications-dropdown"
                                    class="hidden absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-md shadow-lg z-50 border border-gray-200 dark:border-gray-600">
                                    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                                        <div class="flex items-center justify-between">
                                            <h3 class="font-semibold text-gray-900 dark:text-white">Notifications</h3>
                                            <a href="#"
                                                class="text-sm text-forest dark:text-meadow hover:underline">Marquer
                                                tout comme lu</a>
                                        </div>
                                    </div>
                                    <div class="max-h-96 overflow-y-auto">
                                        <!-- Notification items -->
                                        <a href="#"
                                            class="block px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-blue-50 dark:bg-blue-900/20 hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                            <div class="flex">
                                                <div class="flex-shrink-0 mr-3">
                                                    <div
                                                        class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-800 flex items-center justify-center text-blue-500 dark:text-blue-300">
                                                        <i class="fas fa-shopping-bag"></i>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                        Nouvelle demande de location</p>
                                                    <p class="text-sm text-gray-600 dark:text-gray-400">Mehdi souhaite
                                                        louer votre "Pack Camping Complet 2p"</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">Il y a 23
                                                        minutes</p>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex">
                                                <div class="flex-shrink-0 mr-3">
                                                    <div
                                                        class="w-10 h-10 rounded-full bg-green-100 dark:bg-green-800 flex items-center justify-center text-green-500 dark:text-green-300">
                                                ...
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                        Paiement reçu</p>
                                                    <p class="text-sm text-gray-600 dark:text-gray-400">Leila a payé 900
                                                        MAD pour "Pack Camping Complet 2p"</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">Il y a 1
                                                        heure</p>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex">
                                                <div class="flex-shrink-0 mr-3">
                                                    <div
                                                        class="w-10 h-10 rounded-full bg-amber-100 dark:bg-amber-800 flex items-center justify-center text-amber-500 dark:text-amber-300">
                                                        <i class="fas fa-star"></i>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white">Nouvel
                                                        avis reçu</p>
                                                    <p class="text-sm text-gray-600 dark:text-gray-400">Ahmed vous a
                                                        laissé un avis 5 étoiles</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">Il y a 3
                                                        heures</p>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#"
                                            class="block px-4 py-3 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                            <div class="flex">
                                                <div class="flex-shrink-0 mr-3">
                                                    <div
                                                        class="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-800 flex items-center justify-center text-indigo-500 dark:text-indigo-300">
                                                        <i class="fas fa-bullhorn"></i>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                        Promotion disponible</p>
                                                    <p class="text-sm text-gray-600 dark:text-gray-400">Augmentez votre
                                                        visibilité avec notre offre spéciale</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">Il y a 1
                                                        jour</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="p-3 text-center border-t border-gray-200 dark:border-gray-700">
                                        <a href="#all-notifications"
                                            class="text-sm font-medium text-forest dark:text-meadow hover:underline">Voir
                            ...
                            <div class="relative">
                                <button id="user-menu-button" class="flex items-center space-x-2 focus:outline-none">
                                    <img src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80"
                                        alt="Fatima Benali" class="h-8 w-8 rounded-full object-cover" />
                                ...
                                <div id="user-dropdown"
                                    class="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg z-50 border border-gray-200 dark:border-gray-600">
                                    <div class="py-1">
                                        <a href="#profile"
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="flex-shrink-0">
                        <img src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80"
                            alt="Fatima Benali" class="h-10 w-10 rounded-full" />
                    </div>
                    <div class="ml-3">
                        <div class="text-base font-medium text-gray-800 dark:text-white">Fatima Benali</div>
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-400">fatima.benali@example.com
                        </div>
                    </div>
    ...
    <div class="flex flex-col md:flex-row pt-16">
            ...
            <div class="p-5">
                <div class="mb-6 px-3 flex flex-col items-center">
                    <div class="relative">
                        ...
                        <div
                            class="absolute bottom-1 right-1 bg-green-500 p-1 rounded-full border-2 border-white dark:border-gray-800">
                ...
                <nav class="mt-6 space-y-1">
                    <a href="#dashboard"
                        class="sidebar-link active flex items-center px-4 py-3 text-base font-medium rounded-md transition-colors">
                    ...
                    @if(session('success'))
                        <div
                            class="p-3 bg-green-100 border border-green-400 text-green-700 rounded-md flex items-center justify-between">
                            <div><i class="fas fa-check-circle mr-2"></i>{{ session('success') }}</div>
                            <button onclick="this.parentElement.remove()" class="text-green-600 hover:text-green-800"><i
                    ...
                    @auth
                        <div class="pt-4 text-center">
                            <a href="{{ route('download.contract') }}"
                    ...
                    <a href="#equipment"
                        class="sidebar-link flex items-center px-4 py-3 text-base font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-campground w-5 mr-3"></i>
                        Mes équipements
                    </a>
                    <a href="#rental-requests"
                        class="sidebar-link flex items-center px-4 py-3 text-base font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <a href="#current-rentals"
                        class="sidebar-link flex items-center px-4 py-3 text-base font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-exchange-alt w-5 mr-3"></i>
                        Locations en cours
                        <span
                            class="ml-auto bg-blue-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">2</span>
                    </a>
                    <a href="#my-reservations"
                        ...
                        Mes réservations
                        <span
                            class="ml-auto bg-purple-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">2</span>
                    </a>
                ...
                <div class="mt-8 px-4 py-5 bg-forest dark:bg-meadow bg-opacity-10 dark:bg-opacity-10 rounded-lg">
                    <h3 class="text-forest dark:text-meadow font-medium mb-2">Augmentez votre visibilité</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm mb-3">Rendez vos annonces plus visibles avec
                        notre pack premium.</p>
                    <a href="#premium"
                        class="inline-flex items-center px-3 py-1.5 bg-forest hover:bg-green-700 dark:bg-meadow dark:hover:bg-green-600 text-white text-sm rounded-md transition-colors">
                        En savoir plus
        ...
        <div class="md:hidden fixed bottom-4 right-4 z-50">
            <button id="mobile-sidebar-toggle"
                class="w-14 h-14 rounded-full bg-forest text-white shadow-lg flex items-center justify-center">
            ...
            <div class="py-8 px-4 md:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mt-1">Bienvenue, Fatima ! Voici un résumé de votre
                            activité.</p>
                    </div>
                    <div class="mt-4 md:mt-0 flex space-x-3">
                        <a href="#add-equipment"
                            class="inline-flex items-center px-4 py-2 bg-forest hover:bg-green-700 text-white rounded-md shadow-sm transition-colors">
                            <i class="fas fa-plus mr-2"></i>
                            Ajouter un équipement
                        </a>
                        <button id="view-public-profile"
                            class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md shadow-sm transition-colors">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white">2,850 MAD</h3>
                                <p class="text-green-600 dark:text-green-400 text-sm flex items-center mt-1">
                                    <i class="fas fa-arrow-up mr-1"></i>
                                    12% <span class="text-gray-500 dark:text-gray-400 ml-1">vs mois dernier</span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-blue-600 dark:text-blue-400 text-sm flex items-center mt-1">
                                    <i class="fas fa-arrow-up mr-1"></i>
                                    5 <span class="text-gray-500 dark:text-gray-400 ml-1">ce mois-ci</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white">4.8 / 5</h3>
                                <p class="text-amber-600 dark:text-amber-400 text-sm flex items-center mt-1">
                                    <i class="fas fa-comment mr-1"></i>
                                    42 <span class="text-gray-500 dark:text-gray-400 ml-1">avis au total</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white">4 / 5</h3>
                                <p class="text-purple-600 dark:text-purple-400 text-sm flex items-center mt-1">
                                    <i class="fas fa-plus mr-1"></i>
                                    <span class="text-gray-500 dark:text-gray-400">1 place disponible</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                        ...
                        <div class="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 text-center">
                            <a href="#all-activity"
                                class="text-forest dark:text-meadow hover:underline text-sm font-medium">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                        <div
                            ...
                            <span
                                class="bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 px-3 py-1 text-xs font-medium rounded-full">
                                3 en attente
                            </span>
                        </div>
                        <div class="divide-y divide-gray-200 dark:divide-gray-700">
                            <div class="px-6 py-4">
                                <div class="flex items-start">
                                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                                        alt="Mehdi Idrissi" class="w-10 h-10 rounded-full object-cover mr-4" />

                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-1">
                                            <h3 class="font-medium text-gray-900 dark:text-white">Mehdi Idrissi</h3>
                                            <span class="text-xs text-gray-500 dark:text-gray-400">Il y a 23 min</span>
                                        </div>
                                        <p class="text-gray-600 dark:text-gray-400 text-sm mb-2">
                                            Souhaite louer <span class="font-medium">Pack Camping Complet 2p</span>
                                        </p>
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded p-2 mb-3">
                                            <div class="flex justify-between text-sm mb-1">
                                                <span class="text-gray-600 dark:text-gray-400">Dates:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">10 - 15 Août
                                                    2023</span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600 dark:text-gray-400">Montant total:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">2,250 MAD (5
                                                    jours)</span>
                                            </div>
                                        </div>
                                        <div class="flex space-x-2">
                                            <button
                                                class="px-3 py-1.5 bg-forest hover:bg-green-700 text-white text-sm rounded-md transition-colors flex-1">
                                                Accepter
                                            </button>
                                            <button
                                                class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex-1">
                                                Refuser
                                            </button>
                                            <button
                                                class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <div class="px-6 py-4">
                                <div class="flex items-start">
                                    <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                                        alt="Leila Mansouri" class="w-10 h-10 rounded-full object-cover mr-4" />

                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-1">
                                            <h3 class="font-medium text-gray-900 dark:text-white">Leila Mansouri</h3>
                                            <span class="text-xs text-gray-500 dark:text-gray-400">Il y a 1h
                                                10min</span>
                                        </div>
                                        <p class="text-gray-600 dark:text-gray-400 text-sm mb-2">
                                            Souhaite louer <span class="font-medium">Tente Légère 2 Personnes</span>
                                        </p>
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded p-2 mb-3">
                                            <div class="flex justify-between text-sm mb-1">
                                                <span class="text-gray-600 dark:text-gray-400">Dates:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">20 - 24 Août
                                                    2023</span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600 dark:text-gray-400">Montant total:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">720 MAD (4
                                                    jours)</span>
                                            </div>
                                        </div>
                                        <div class="flex space-x-2">
                            ...
                            <div class="px-6 py-4">
                                <div class="flex items-start">
                                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                                        alt="Youssef Alami" class="w-10 h-10 rounded-full object-cover mr-4" />

                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-1">
                                            <h3 class="font-medium text-gray-900 dark:text-white">Youssef Alami</h3>
                                            <span class="text-xs text-gray-500 dark:text-gray-400">Il y a 5h
                                                27min</span>
                                        </div>
                                        <p class="text-gray-600 dark:text-gray-400 text-sm mb-2">
                                            Souhaite louer <span class="font-medium">Sacs de Couchage Ultra
                                                Confort</span>
                                        </p>
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded p-2 mb-3">
                                            <div class="flex justify-between text-sm mb-1">
                                                <span class="text-gray-600 dark:text-gray-400">Dates:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">15 - 18 Août
                                                    2023</span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600 dark:text-gray-400">Montant total:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">450 MAD (3
                                                    jours)</span>
                                            </div>
                                        </div>
                                        <div class="flex space-x-2">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                            <div class="relative h-40">
                                <img src="https://images.unsplash.com/photo-1530541930197-ff16ac917b0e?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80"
                                    alt="Grande Tente 6 Personnes" class="w-full h-full object-cover" />
                            ...
                            <div class="p-4">
                                <div class="flex items-start mb-4">
                                    <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                                        alt="Omar Tazi" class="w-8 h-8 rounded-full object-cover mr-3" />
                                    <div>
                                        <p class="font-medium text-gray-900 dark:text-white">Omar Tazi</p>
                                        <div class="flex items-center text-sm">
                                            <i class="fas fa-star text-amber-400 mr-1"></i>
                                            <span>4.9 <span class="text-gray-500 dark:text-gray-400">(26
                                                    avis)</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700/50 rounded p-3 mb-4">
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-white">1 250 MAD (5
                                            jours)</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button
                                        class="px-3 py-1.5 bg-forest hover:bg-green-700 text-white text-sm rounded-md transition-colors">
                                        <i class="fas fa-comment-alt"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                            <div class="relative h-40">
                                <img src="https://images.unsplash.com/photo-1510312305653-8ed496efae75?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80"
                                    alt="Réchaud Camping + Kit Cuisine" class="w-full h-full object-cover" />
                                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                <div class="absolute top-4 left-4">
                                    <span class="bg-amber-500 text-white text-xs px-2 py-1 rounded-full">En
                                        attente</span>
                                </div>
                                <div class="absolute bottom-4 left-4 right-4">
                            ...
                            <div class="p-4">
                                <div class="flex items-start mb-4">
                                    <img src="https://images.unsplash.com/photo-1548544149-4835e62ee5b3?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                                        alt="Salma Benani" class="w-8 h-8 rounded-full object-cover mr-3" />
                                    <div>
                                        <p class="font-medium text-gray-900 dark:text-white">Salma Benani</p>
                                        <div class="flex items-center text-sm">
                                            <i class="fas fa-star text-amber-400 mr-1"></i>
                                            <span>4.7 <span class="text-gray-500 dark:text-gray-400">(18
                                                    avis)</span></span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#equipment" class="text-forest dark:text-meadow hover:underline text-sm font-medium">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        ...
                        <div class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                            <div class="relative h-48">
                                <img src="https://images.unsplash.com/photo-1504851149312-7a075b496cc7?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80"
                                    alt="Pack Camping Complet 2p" class="w-full h-full object-cover" />
                                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                <div class="absolute top-4 left-4">
                        ...
                        <div class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                            <div class="relative h-48">
                                <img src="https://images.unsplash.com/photo-1520100504277-3c63ebf5c2c6?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80"
                                    alt="Sacs de couchage ultra confort" class="w-full h-full object-cover" />
                                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                <div class="absolute top-4 left-4">
                                    <span class="bg-green-500 text-white text-xs px-2 py-1 rounded-full">Actif</span>
                                </div>
                                <div class="absolute bottom-4 left-4 right-4">
                                    <h3 class="text-white font-bold text-lg truncate">Sacs de Couchage Ultra Confort
                                    </h3>
                        ...
                        <div class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                            <div class="relative h-48">
                                <img src="https://images.unsplash.com/photo-1474044159687-1ee9f3a51722?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80"
                                    alt="Matelas gonflable" class="w-full h-full object-cover" />
                                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                <div class="absolute top-4 left-4">
                                    <span class="bg-green-500 text-white text-xs px-2 py-1 rounded-full">Actif</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="text-sm text-gray-600 dark:text-gray-300">
                                        <span class="text-blue-600 dark:text-blue-400">
                                            <i class="fas fa-calendar-check mr-1"></i> Loué (1 août - 5 août)
                                        </span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <a href="#edit-equipment"
                        ...
                        <div class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                            <div class="relative h-48">
                                <img src="https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80"
                                    alt="Tente légère" class="w-full h-full object-cover" />
                                <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                <div class="absolute top-4 left-4">
                                    <span class="bg-amber-500 text-white text-xs px-2 py-1 rounded-full">Archivé</span>
                                </div>
                                <div class="absolute bottom-4 left-4 right-4">
                                    <h3 class="text-white font-bold text-lg truncate">Tente Légère 2 Personnes</h3>
                                    <p class="text-gray-200 text-sm">Coleman - Excellent état</p>
                                </div>
                            </div>
                            <div class="p-4">
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    <div class="flex items-center text-sm">
                                        <i class="fas fa-star text-amber-400 mr-1"></i>
                                        <span>4.6 <span class="text-gray-500 dark:text-gray-400">(8)</span></span>
                                    </div>
                                </div>

                                <div class="text-sm mb-3">
                                    <span class="text-gray-600 dark:text-gray-300">Dispo. du 1 août au 15 sept.</span>
                                </div>

                                <div class="flex items-center justify-between">
                                    <div class="text-sm text-gray-600 dark:text-gray-300">
                                        <button
                                            class="text-forest dark:text-meadow font-medium hover:text-green-700 dark:hover:text-green-400 transition-colors">
                                            <i class="fas fa-redo-alt mr-1"></i> Réactiver
                                        </button>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <a href="#edit-equipment"
                        ...
                        <!-- Add Equipment Card -->
                        <div
                            class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border-2 border-dashed border-gray-300 dark:border-gray-600 flex flex-col items-center justify-center h-80">
                            <div class="p-6 text-center">
                                <div
                                    class="w-16 h-16 bg-forest/10 dark:bg-forest/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <i class="fas fa-plus text-forest dark:text-meadow text-xl"></i>
                                </div>
                                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Ajouter un équipement
                                </h3>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-5">
                            <div class="flex justify-between items-start">
                                <div class="flex">
                                    <div class="mr-4">
                                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                                            alt="Ahmed Kaddour" class="w-12 h-12 rounded-full object-cover" />
                                    </div>
                                    <div>
                            ...
                            <div class="mt-4">
                                <h5 class="font-semibold text-gray-900 dark:text-white mb-2">Partenaire exemplaire,
                                    service impeccable!</h5>
                                <p class="text-gray-600 dark:text-gray-300 text-sm line-clamp-3">
                                    Fatima a été extrêmement professionnelle du début à la fin. Elle a répondu à toutes
                                    mes questions en moins d'une heure, m'a donné d'excellents conseils pour mon séjour
                                    au lac, et a été très flexible pour la remise et le retour du matériel.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-5">
                            <div class="flex justify-between items-start">
                                <div class="flex">
                                    <div class="mr-4">
                                        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                                            alt="Leila Mansouri" class="w-12 h-12 rounded-full object-cover" />
                                    </div>
                                    <div>
                            ...
                            <div class="mt-4">
                                <h5 class="font-semibold text-gray-900 dark:text-white mb-2">Une partenaire fiable et
                                    attentionnée</h5>
                                <p class="text-gray-600 dark:text-gray-300 text-sm line-clamp-3">
                                    Expérience parfaite avec Fatima! Elle est très organisée et ponctuelle. Les sacs de
                                    couchage étaient propres et très confortables comme promis. Fatima nous a même
                                    envoyé un message pendant notre séjour pour s'assurer que tout se passait bien.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div id="equipment-settings-modal"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-lg w-full mx-4">
            <div class="p-5 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                ...
                <button id="close-equipment-settings"
            ...
            <div class="p-5">
                <div class="flex items-center mb-6">
                    <img src="https://images.unsplash.com/photo-1504851149312-7a075b496cc7?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                        alt="Pack Camping Complet 2p" class="w-14 h-14 rounded-md object-cover mr-4" />
                    <div>
            ...
            <div class="p-5 border-t border-gray-200 dark:border-gray-700 flex justify-end">
                <button id="cancel-equipment-settings"
                    class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-md mr-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    Annuler
                </button>
                <button
                    class="px-4 py-2 bg-forest hover:bg-green-700 text-white font-medium rounded-md shadow-sm transition-colors">
                    Enregistrer
                </button>
            </div>
        </div>
    ...
    <div id="message-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] flex flex-col">
            <div class="p-5 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                <div class="flex items-center">
                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80"
                        alt="Mehdi Idrissi" class="w-10 h-10 rounded-full object-cover mr-3" />
                    <div>
                ...
                <div class="chat-container">
                    ...
                    <div class="chat-message incoming">
                        <div class="chat-bubble">
                            <p class="text-gray-800 dark:text-gray-200">Bonjour ! Je suis intéressé par votre Pack
                                Camping Complet 2p pour un séjour au lac Lalla Takerkoust du 10 au 15 août. Est-ce qu'il
                                est disponible durant cette période ?</p>
                    ...
                    <div class="chat-message outgoing">
                        <div class="chat-bubble">
                            <p class="text-white">Bonjour Mehdi, oui le pack est disponible pour ces dates ! Avez-vous
                                besoin d'informations supplémentaires sur le contenu du pack ?</p>
                    ...
                    <div class="chat-message incoming">
                        <div class="chat-bubble">
                            <p class="text-gray-800 dark:text-gray-200">Super ! Est-ce que le pack inclut des assiettes
                                et des couverts ? Nous serons 2 personnes.</p>
                    ...
                    <div class="chat-message outgoing">
                        <div class="chat-bubble">
                            <p class="text-white">Oui, le pack comprend 2 sets d'assiettes, bols, couverts et tasses en
                                plastique réutilisable. Il y a aussi une petite casserole, une poêle et une bouilloire.
                            </p>
                ...
                <form id="message-form" class="flex items-end">
                    <div class="flex-grow">
                        <textarea id="message-input" placeholder="Tapez votre message..."
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-forest dark:focus:ring-meadow text-base resize-none custom-input"
                            rows="3"></textarea>
                    </div>
                    <div class="ml-3 flex flex-col space-y-2">
                        ...
                        <button type="submit"
                            class="p-2 bg-forest hover:bg-green-700 text-white rounded-md shadow-sm transition-colors">
