...
@endauth
                ...
                <div class="mt-8 px-4 py-5 bg-forest dark:bg-meadow bg-opacity-10 dark:bg-opacity-10 rounded-lg">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm mb-3">Rendez vos annonces plus visibles avec notre pack premium.</p>
            ...
            <div class="py-8 px-4 md:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mt-1">Bienvenue, Fatima ! Voici un résumé de votre activité.</p>
                    </div>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded p-2 mb-3">
                                            <div class="flex justify-between text-sm mb-1">
                                                ...
                                                <span class="font-medium text-gray-900 dark:text-white">10 - 15 Août 2023</span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600 dark:text-gray-400">Montant total:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">2,250 MAD (5 jours)</span>
                                            </div>
                                        </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-1">
                                            ...
                                            <span class="text-xs text-gray-500 dark:text-gray-400">Il y a 1h 10min</span>
                                        </div>
                                        <p class="text-gray-600 dark:text-gray-400 text-sm mb-2">
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded p-2 mb-3">
                                            <div class="flex justify-between text-sm mb-1">
                                                <span class="text-gray-600 dark:text-gray-400">Dates:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">20 - 24 Août 2023</span>
                                            </div>
                                            <div class="flex justify-between text-sm">
                                                <span class="text-gray-600 dark:text-gray-400">Montant total:</span>
                                                <span class="font-medium text-gray-900 dark:text-white">720 MAD (4 jours)</span>
                                            </div>
                                        </div>
                                        <div class="flex space-x-2">
                                            <button class="px-3 py-1.5 bg-forest hover:bg-green-700 text-white text-sm rounded-md transition-colors flex-1">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-1">
                                            ...
                                            <span class="text-xs text-gray-500 dark:text-gray-400">Il y a 5h 27min</span>
                                        </div>
                                        <p class="text-gray-600 dark:text-gray-400 text-sm mb-2">
                                            Souhaite louer <span class="font-medium">Sacs de Couchage Ultra Confort</span>
                                        </p>
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded p-2 mb-3">
                                            <div class="flex justify-between text-sm mb-1">
                                                <span class="text-gray-600 dark:text-gray-400">Dates:</span>
