...
<body class="font-sans antialiased text-gray-800 dark:text-gray-200 dark:bg-gray-900 min-h-screen flex flex-col">
                                ...
                                <div id="notifications-dropdown" class="hidden absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-md shadow-lg z-50 border border-gray-200 dark:border-gray-600">
                                    ...
                                    <div class="max-h-96 overflow-y-auto">
                                        ...
                                        <a href="#" class="block px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-blue-50 dark:bg-blue-900/20 hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                            <div class="flex">
                                                <div class="flex-shrink-0 mr-3">
                                                    <div class="w-10 h-10 rounded-full bg-amber-100 dark:bg-amber-900 flex items-center justify-center text-amber-500 dark:text-amber-300">
                                        ...
                                        <a href="#" class="block px-4 py-3 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                            <div class="flex">
                                                <div class="flex-shrink-0 mr-3">
                                                    <div class="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center text-indigo-500 dark:text-indigo-300">
                                                        <i class="fas fa-bullhorn"></i>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white">Promotion disponible</p>
                                                    <p class="text-sm text-gray-600 dark:text-gray-400">Augmentez votre visibilité avec notre offre spéciale</p>
        ...
        <aside class="hidden md:block w-64 bg-white dark:bg-gray-800 shadow-md h-screen fixed overflow-y-auto">
            <div class="p-5">
                <div class="mb-6 px-3 flex flex-col items-center">
                    <div class="relative">
                        <img src="{{ $partner->avatar_url ? asset('storage/' . $partner->avatar_url) : 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80' }}" 
                        ...
                        <button id="change-avatar-btn" class="absolute top-0 right-0 bg-forest dark:bg-meadow text-white p-1 rounded-full border-2 border-white dark:border-gray-800 hover:bg-green-600 dark:hover:bg-green-500 transition-colors">
                            <i class="fas fa-camera text-xs"></i>
                        </button>
                    </div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-4">{{ $partner->username }}</h2>
                    <div class="text-sm text-gray-500 dark:text-gray-400">Partenaire depuis {{ \Carbon\Carbon::parse($partner->created_at)->format('Y') }}</div>
                ...
                <nav class="mt-6 space-y-1">
                    ...
                    <a href="{{ route('partner.equipment') }}" class="sidebar-link flex items-center px-4 py-3 text-base font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                ...
                <div class="mt-8 px-4 py-5 bg-forest dark:bg-meadow bg-opacity-10 dark:bg-opacity-10 rounded-lg">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm mb-3">
                        Rendez vos annonces plus visibles avec notre pack premium.
                    </p>
                    <a href="#premium" class="inline-flex items-center px-3 py-1.5 bg-forest hover:bg-green-700 dark:bg-meadow dark:hover:bg-green-600 text-white text-sm rounded-md transition-colors">
                        En savoir plus
        ...
        <div id="mobile-sidebar" class="md:hidden fixed inset-y-0 left-0 transform -translate-x-full w-64 bg-white dark:bg-gray-800 shadow-xl z-50 transition-transform duration-300">
            <div class="p-5">
                ...
                <div class="mb-6 px-3 flex flex-col items-center">
                    ...
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white mt-3">{{ $partner->username }}</h2>
                    <div class="text-sm text-gray-500 dark:text-gray-400">Partenaire depuis {{ \Carbon\Carbon::parse($partner->created_at)->format('Y') }}</div>
            ...
            <div class="py-8 px-4 md:px-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                    <div>
                        ...
                        <p class="mt-1 text-gray-600 dark:text-gray-400">Bienvenue, {{ $partner->username }} ! Voici un aperçu de votre activité.</p>
                    </div>
                    <div class="mt-4 md:mt-0">
                        <a href="{{ route('listing.create') }}" class="inline-flex items-center px-4 py-2 bg-forest dark:bg-meadow text-white font-medium rounded-md shadow-sm hover:bg-forest/90 dark:hover:bg-meadow/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-forest dark:focus:ring-meadow transition-colors">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            <div class="p-3 rounded-full bg-green-100 dark:bg-green-900 mr-4">
                                <i class="fas fa-campground text-green-600 dark:text-green-400"></i>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Équipements</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white" data-stat="total-listings">{{ $totalListings }}</p>
                            </div>
                        </div>
                        <div class="mt-4">
                            <a href="{{ route('partner.equipment') }}" class="text-sm font-medium text-forest dark:text-meadow hover:underline">Voir tous les équipements</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white" data-stat="total-reservations">{{ $totalReservations }}</p>
                            </div>
                        </div>
                        <div class="mt-4">
                            <a href="#reservations" class="text-sm font-medium text-forest dark:text-meadow hover:underline">Voir toutes les réservations</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white" data-stat="average-rating">{{ number_format($averageRating, 1) }}/5</p>
                            </div>
                        </div>
                        <div class="mt-4">
                            <a href="#reviews" class="text-sm font-medium text-forest dark:text-meadow hover:underline">Voir tous les avis</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white" data-stat="total-revenue">{{ number_format($totalRevenue, 0) }} DH</p>
                            </div>
                        </div>
                        <div class="mt-4">
                            <a href="#earnings" class="text-sm font-medium text-forest dark:text-meadow hover:underline">Voir les détails</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div>
                                            @if($activity['type'] == 'reservation')
                                                <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                    Nouvelle réservation de {{ $activity['data']->client->username ?? 'Client' }}
                                                </p>
                                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                                    {{ $activity['data']->listing->title ?? 'Équipement' }} - 
                                                    {{ \Carbon\Carbon::parse($activity['data']->start_date)->format('d/m/Y') }} au 
                                                    {{ \Carbon\Carbon::parse($activity['data']->end_date)->format('d/m/Y') }}
                                                </p>
                                            @elseif($activity['type'] == 'review')
                                                <p class="text-sm font-medium text-gray-900 dark:text-white">
                                                    Nouvel avis de {{ $activity['data']->reservation->client->username ?? 'Client' }}
                                                </p>
                                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                                    {{ $activity['data']->reservation->listing->title ?? 'Équipement' }} - 
                                                    Note: {{ $activity['data']->rating }}/5
                                                </p>
                                            @endif
                        ...
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                            ...
                            @if($pendingReservations->count() > 0)
                                <span class="bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 px-3 py-1 text-xs font-medium rounded-full">
                                    {{ $pendingReservations->count() }} en attente
                                </span>
                            @endif
                        </div>
                        <div class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($pendingReservations->take(3) as $reservation)
                                <div class="px-6 py-4">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex justify-between items-start">
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                                        {{ $reservation->listing->title ?? 'Équipement' }}
                                                    </p>
                                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">
                                                        {{ \Carbon\Carbon::parse($reservation->start_date)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($reservation->end_date)->format('d/m/Y') }}
                                                    </p>
                                                </div>
                                                <span class="text-xs font-medium px-2 py-1 rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300">
                                                    En attente
                                                </span>
                                            </div>
                                            <div class="mt-3 flex space-x-2">
                                                <button class="px-3 py-1.5 bg-forest text-white text-xs font-medium rounded hover:bg-forest/90 dark:bg-meadow dark:hover:bg-meadow/90 transition-colors">
                                                    Accepter
                                                </button>
                                                <button class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-xs font-medium rounded hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                    Refuser
                                                </button>
                                                <button class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-xs font-medium rounded hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                    Message
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                            <div class="relative h-40">
                                <img src="https://images.unsplash.com/photo-1530541930197-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" 
                            ...
                            <div class="p-4">
                                <div class="flex items-start mb-4">
                                    <img src="https://images.unsplash.com/photo-1510312305653-8ed496efae75?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80" 
                                         alt="Omar Tazi" 
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                            <div class="relative h-40">
                                <img src="https://images.unsplash.com/photo-1519085360753-c7b5b0dd90a7?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" 
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('partner.equipment') }}" class="text-forest dark:text-meadow hover:underline text-sm font-medium">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        ...
                        <div class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="text-sm text-gray-600 dark:text-gray-300">
                                        <button class="text-forest dark:text-meadow font-medium hover:text-green-700 dark:hover:text-green-400 transition-colors">
                        ...
                        <div class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border-2 border-dashed border-gray-300 dark:border-gray-600 flex flex-col items-center justify-center h-80">
                            <div class="p-6 text-center">
                                ...
                                <a href="#add-equipment" class="inline-flex items-center px-3 py-1.5 bg-forest hover:bg-green-700 dark:bg-meadow dark:hover:bg-green-600 text-white text-sm rounded-md transition-colors">
                                    <i class="fas fa-plus mr-2"></i>
                                    Ajouter
                                </a>
                            </div>
            ...
            <div class="p-5">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <button id="edit-details-btn" class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            Éditer
                        </button>
                    </div>
    ...
    <div id="avatar-upload-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="p-5 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">Changer ma photo de profil</h3>
                <button id="close-avatar-upload" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            
            <form action="{{ route('partner.update-avatar') }}" method="POST" enctype="multipart/form-data" class="p-5">
                @csrf
                <div class="mb-5 text-center">
                    <div class="avatar-preview mx-auto mb-4 relative">
                        <img id="avatar-preview-img" src="{{ $partner->avatar_url ? asset('storage/' . $partner->avatar_url) : 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80' }}" 
                             alt="{{ $partner->username }}" 
                             class="w-32 h-32 rounded-full border-4 border-forest dark:border-meadow object-cover mx-auto" />
                    </div>
                    
                    <label for="avatar-upload" class="cursor-pointer inline-flex items-center px-4 py-2 bg-forest hover:bg-green-700 dark:bg-meadow dark:hover:bg-green-600 text-white rounded-md transition-colors">
                        <i class="fas fa-upload mr-2"></i>
                        Choisir une photo
                    </label>
                    <input type="file" id="avatar-upload" name="avatar" class="hidden" accept="image/*" required />
                ...
                <div class="flex justify-end">
                    <button type="button" id="cancel-avatar-upload" class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-md mr-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        Annuler
                    </button>
                    <button type="submit" class="px-4 py-2 bg-forest hover:bg-green-700 dark:bg-meadow dark:hover:bg-green-600 text-white font-medium rounded-md transition-colors">
                        Enregistrer
                    </button>
                </div>
            </form>
    ...
    <script>
        // Script pour le modal de téléchargement d'avatar
        document.addEventListener('DOMContentLoaded', function() {
            const changeAvatarBtn = document.getElementById('change-avatar-btn');
            const avatarUploadModal = document.getElementById('avatar-upload-modal');
            const closeAvatarUpload = document.getElementById('close-avatar-upload');
            ...
            // Fermer le modal
            closeAvatarUpload?.addEventListener('click', function() {
                avatarUploadModal.classList.add('hidden');
                document.body.classList.remove('overflow-hidden');
            });
            
            cancelAvatarUpload?.addEventListener('click', function() {
                avatarUploadModal.classList.add('hidden');
                document.body.classList.remove('overflow-hidden');
            });
    ...
    <script>
        // Mettre à jour les conteneurs avec les données du partenaire
        document.addEventListener('DOMContentLoaded', function() {
            // Récupérer les données du tableau de bord depuis la variable window.dashboardData
            if (window.dashboardData) {
                // Les statistiques sont déjà mises à jour avec les attributs data-stat
                
                // Mettre à jour le nom du partenaire dans l'en-tête
                const partnerNameElement = document.querySelector('.mt-1.text-gray-600.dark\\:text-gray-400');
                if (partnerNameElement && window.dashboardData.partner) {
                    partnerNameElement.textContent = `Bienvenue, ${window.dashboardData.partner.username} ! Voici un aperçu de votre activité.`;
                }
                ...
                equipmentLinks.forEach(link => {
                    link.href = "{{ route('partner.equipment') }}";
                });
            }
