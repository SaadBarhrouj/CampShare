...
@section('content')
        ...
        <div class="hidden md:flex items-center space-x-6">
            ...
            @endauth
                ...
                <div class="md:hidden flex items-center">
                    <button id="mobile-menu-button" aria-label="Menu principal" aria-expanded="false" class="text-gray-600 dark:text-gray-300 hover:text-admin-primary dark:hover:text-admin-secondary focus:outline-none focus:ring-2 focus:ring-admin-primary rounded p-1">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-4">
                    <div class="flex-shrink-0">
                        <div class="h-10 w-10 rounded-full bg-admin-primary/20 flex items-center justify-center text-admin-primary" aria-hidden="true">
                    ...
                    <div class="ml-auto flex items-center space-x-4">
                        <button aria-label="Notifications" class="flex-shrink-0 p-1 rounded-full text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 relative focus:outline-none focus:ring-2 focus:ring-admin-primary">
                            <i class="fas fa-bell text-lg" aria-hidden="true"></i>
                            <span class="absolute top-0 right-0 -mt-1 -mr-1 bg-red-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center" aria-label="5 nouvelles notifications">5</span>
                        </button>
                        <button aria-label="Paramètres" class="flex-shrink-0 p-1 rounded-full text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-admin-primary">
                            <i class="fas fa-cog text-lg" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
                <div class="mt-3 space-y-1 px-2">
                    <a href="#profile" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-user-circle mr-2 opacity-70" aria-hidden="true"></i> Mon profil
                    </a>
                    <a href="#account-settings" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-cog mr-2 opacity-70" aria-hidden="true"></i> Paramètres
                    </a>
                    <a href="#admin-logs" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-history mr-2 opacity-70" aria-hidden="true"></i> Historique d'actions
                    </a>

                    <div class="border-t border-gray-200 dark:border-gray-700 my-2"></div>
                    
                    <a href="#logout" class="block px-3 py-2 rounded-md text-base font-medium text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
    ...
    <div class="flex pt-16">
        <!-- Sidebar amélioré -->
        <aside class="hidden md:block w-64 bg-white dark:bg-gray-800 shadow-md h-screen fixed overflow-y-auto border-r border-gray-100 dark:border-gray-700">
            <div class="p-5">
                <div class="mb-6 px-2">
                ...
                <div class="mb-6 px-2">
                    <h5 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 pl-3">
                        Utilisateurs</h5>
                    <nav class="space-y-1" aria-label="Menu utilisateurs">
                        <a href="#"
                            class="sidebar-link flex items-center px-3 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-admin-primary">
                            <i class="fas fa-handshake w-5 mr-3 text-gray-500 dark:text-gray-400" aria-hidden="true"></i>
                            Partenaires
                        </a>
                        <a href="#"
                            class="sidebar-link flex items-center px-3 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-admin-primary">
                            <i class="fas fa-users w-5 mr-3 text-gray-500 dark:text-gray-400" aria-hidden="true"></i>
                            Clients
                        </a>
                    </nav>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        @forelse ($reservationStats as $status => $total)
                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg shadow">
                                <p class="text-sm uppercase font-semibold text-gray-600 dark:text-gray-300">{{ ucfirst($status) }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" aria-label="Liste des réservations">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Partenaire</th>
                                    ...
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Début</th>
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Fin</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach($reservations as $reservation)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-200">{{ $reservation->id }}</td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-200">{{ $reservation->client->first_name }} {{ $reservation->client->last_name }}</td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-200">{{ $reservation->partner->first_name }} {{ $reservation->partner->last_name }}</td>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-200">{{ $reservation->start_date }}</td>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-200">{{ $reservation->end_date }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
