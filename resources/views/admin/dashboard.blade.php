...
<body class="font-sans antialiased text-gray-800 dark:text-gray-200 dark:bg-gray-900 min-h-screen flex flex-col">
    <!-- Votre navigation et sidebar existantes restent inchangées -->
    <nav
            ...
            <div class="flex justify-between h-16">
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <a href="admin-dashboard.html" class="flex items-center">
                        <span class="text-admin-primary dark:text-admin-secondary text-3xl font-extrabold">Camp<span
                                class="text-sunlight">Share</span></span>
                        <span
                            class="text-xs ml-2 text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">ADMIN</span>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="relative">
                        <input type="text" placeholder="Recherche rapide..."
                            class="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-admin-primary dark:focus:ring-admin-secondary w-64 text-sm">
                            ...
                            <div class="relative">
                                <button id="user-menu-button" class="flex items-center space-x-2 focus:outline-none">
                                    <img src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80"
                                        alt="Admin User" class="h-8 w-8 rounded-full object-cover" />
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-4">
                    <div class="flex-shrink-0">
                        <img src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80"
                            alt="Admin User" class="h-10 w-10 rounded-full" />
                    </div>
                    <div class="ml-3">
                ...
                <div class="mb-6 px-3">
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="#reports"
                            ...
                            Signalements
                            <span
                                class="ml-auto bg-red-100 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-xs rounded-full h-5 px-1.5 flex items-center justify-center">5</span>
                        </a>
                    </nav>
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-3xl w-full mx-4 max-h-[90vh] flex flex-col">
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-gray-600 dark:text-gray-400">ID: #<span id="user-id"></span></span>
                    </div>
                </div>
            </div>
        ...
        <div class="p-5 overflow-y-auto flex-grow">
                    ...
                    <div class="space-y-2">
                        ...
                        <div id="partner-info-container" class="hidden">
                            <div class="flex justify-between">
                                ...
                                <span id="user-bank-details" class="font-medium text-gray-900 dark:text-white"></span>
                            </div>
                            <div class="flex justify-between">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span id="user-reservations-count" class="font-medium text-gray-900 dark:text-white">0</span>
                        </div>
                        ...
                        <div id="partner-stats-container" class="hidden">
                            <div class="flex justify-between">
                                ...
                                <span id="user-equipments-count" class="font-medium text-gray-900 dark:text-white">0</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-400">Revenus totaux:</span>
                                <span id="user-total-earnings" class="font-medium text-gray-900 dark:text-white">0 MAD</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="user-reservations-section" class="mb-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg overflow-hidden">
                    <table id="user-reservations" class="w-full admin-table">
                        <thead>
                            <tr class="text-left border-b border-gray-200 dark:border-gray-700">
                                <th class="py-3 pl-6">Équipement</th>
            ...
            <div id="partner-equipment-section" class="mb-6 hidden">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="#" id="view-all-equipments" class="text-sm text-admin-primary dark:text-admin-secondary hover:underline">
                        Voir tous
                    </a>
                </div>
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg overflow-hidden">
            ...
            <div class="mt-6 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <button id="toggle-partner-btn" class="hidden px-3 py-1.5 border border-admin-primary dark:border-admin-secondary text-admin-primary dark:text-admin-secondary text-sm rounded-md hover:bg-admin-light dark:hover:bg-admin-dark/30 transition-colors">
                ...
                <div class="mt-3">
                    ...
                    <textarea id="admin-notes" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm" rows="3" placeholder="Ajouter une note concernant cet utilisateur..."></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="p-5 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
            <button id="save-user-details" class="px-6 py-2 bg-blue-700 hover:bg-blue-800 text-white font-semibold rounded-lg shadow-md transition duration-200 ease-in-out focus:ring-2 focus:ring-blue-400 focus:outline-none">
    ...
    function fillReservations(reservations) {
        ...
        if (reservations && reservations.length > 0) {
            ...
            reservations.forEach(res => {
                const row = document.createElement('tr');
                row.innerHTML = `
                    <td>${res.listing_title || 'Titre inconnu'}</td>
    ...
    document.getElementById('save-user-details').addEventListener('click', async () => {
        ...
        try {
            ...
            document.getElementById('user-status-badge').className = newIsActive ? 'badge badge-success' : 'badge badge-danger';
            document.getElementById('user-active-toggle').checked = newIsActive;

            alert(`Utilisateur ${newIsActive ? 'activé' : 'désactivé'} avec succès`);
