        ...
        <div class="border-t border-gray-200 dark:border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-4">
                ...
                <div class="ml-auto flex items-center space-x-4">
                    <button class="flex-shrink-0 p-1 rounded-full text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 relative">
...
<div class="flex pt-16">
    ...
    <aside class="hidden md:block w-64 bg-white dark:bg-gray-800 shadow-md h-screen fixed overflow-y-auto border-r border-gray-100 dark:border-gray-700">
        <div class="p-5">
            ...
            <div class="mb-6 px-2">
                ...
                <nav class="space-y-1">
                    <a href="#"
                        class="sidebar-link flex items-center px-3 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
   ...
   class="sidebar-link flex items-center px-3 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
    ...
    <!-- Contenu principal avec meilleur espacement et design -->
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex justify-between items-center mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
                ...
                <div class="flex items-center space-x-2">
                    <button class="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                        <i class="fas fa-filter mr-1"></i> Filtrer
                    </button>
                    
                    <button class="px-3 py-1.5 bg-admin-primary text-white rounded-lg text-sm font-medium hover:bg-admin-primary/90 transition-colors">
            ...
            <!-- Grille des équipements améliorée -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @forelse($equipments as $item)
                    <div
                        ...
                        <!-- Image container avec effet de surbrillance -->
                        <div class="relative h-48 overflow-hidden">
                            ...
                            <!-- Badge de prix -->
                            <div class="absolute bottom-0 right-0 bg-yellow-500 text-white px-3 py-1 text-sm font-bold rounded-tl-lg">
                                {{ $item->price_per_day }} € <span class="text-xs font-normal">/ jour</span>
                            </div>
                        </div>

                        <div class="p-4">
                            <h2 class="text-lg font-bold text-gray-800 dark:text-white mb-2 truncate group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{{ $item->title }}</h2>
...
@endphp
                ...
                @empty
                    <div class="col-span-full bg-blue-50 dark:bg-blue-900/20 rounded-lg p-8 text-center">
                        ...
                        <p class="text-blue-600 dark:text-blue-400 font-medium text-lg">Aucun équipement disponible actuellement.</p>
            ...
            <div class="mt-8 flex justify-center">
                <nav class="inline-flex rounded-md shadow">
                    <a href="#" class="py-2 px-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-l-md border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-chevron-left text-xs"></i>
                    </a>
                    <a href="#" class="py-2 px-4 bg-blue-500 text-white font-medium border border-blue-500 hover:bg-blue-600 transition-colors">1</a>
                    <a href="#" class="py-2 px-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">2</a>
                    <a href="#" class="py-2 px-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-r-md border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
