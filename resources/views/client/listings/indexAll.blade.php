                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="py-4 flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <a href="{{ route('client.listings.indexAll', array_merge(request()->except('price_range'), ['price_range' => '0-50'])) }}"
                            ...
                            <a href="{{ route('client.listings.indexAll', array_merge(request()->except('price_range'), ['price_range' => '50-100'])) }}"
                            ...
                            <a href="{{ route('client.listings.indexAll', array_merge(request()->except('price_range'), ['price_range' => '100-200'])) }}"
                            ...
                            <a href="{{ route('client.listings.indexAll', array_merge(request()->except('price_range'), ['price_range' => '200+'])) }}"
                            ...
                            @if(request('price_range'))
                                <a href="{{ route('client.listings.indexAll', request()->except('price_range')) }}"
                                   class="whitespace-nowrap px-4 py-2 bg-red-500 text-white rounded-full font-medium hover:bg-red-600 transition-all">
