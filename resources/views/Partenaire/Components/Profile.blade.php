                        ...
                        <div class="flex flex-col md:flex-row items-start md:items-center">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap gap-6 mt-6">
                                    <div class="flex flex-col items-center">
                                        <div class="text-2xl font-bold text-gray-900 dark:text-white">
                                            <div class="flex items-center mt-2">
                                                @if(isset($profile->avg_rating) && is_numeric($profile->avg_rating))
                                                    @php
                                                        $rating = min(max($profile->avg_rating, 0), 5); // Ensure rating is between 0-5
                                    ...
                                    <div class="flex flex-col items-center">
                                        <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ $NumberReservationCompleted }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">Locations réalisées</div>
                                    </div>

                                    <div class="flex flex-col items-center">
                                        <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ $sumPayment }}</div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <select id="city" name="city" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
