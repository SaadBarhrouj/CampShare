                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative">
                                <button id="user-menu-button" class="flex items-center space-x-2 focus:outline-none">
                                    <img src="{{ asset('storage/' . $user->avatar_url) }}" alt="{{ $user->username }}"
            ...
            <div class="p-5">
                <div class="mb-6 px-3 flex flex-col items-center">
                    <div class="relative w-21 h-21">
                        <img src="{{ asset('storage/' . $user->avatar_url) }}" alt="{{ $user->username }}"
                            class="w-full h-full rounded-full object-cover border-2 border-gray-300 dark:border-gray-600 shadow-lg" />
                ...
                <nav class="mt-6 space-y-1">
                    ...
                    <a href="#equipment" data-target="AllMyEquipement"
                    ...
                    <a href="#rental-requests" data-target="AllMyReservation"
                        class="sidebar-link flex items-center px-4 py-3 text-base font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-clipboard-list w-5 mr-3"></i>
                        Demandes de location
                        <span
                            class="ml-auto bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">{{$NumberPendingReservation}}</span>
                    </a>
                    <a href="#current-rentals" data-target="LocationsEncours"
                        class="sidebar-link flex items-center px-4 py-3 text-base font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <i class="fas fa-exchange-alt w-5 mr-3"></i>
                        Locations en cours
                        <span
                            class="ml-auto bg-blue-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">{{$NumberLocationsEncours}}</span>
                    </a>
