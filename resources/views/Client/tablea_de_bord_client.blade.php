            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="flex-shrink-0">
                        <img src=<img src="{{ $user->avatar_url }}" alt="Avatar de {{ $user->name }}" 
                ...
                <div class="mt-3 space-y-1 px-2">
                    <a href="#profile" data-target="profile" class="sidebar-link block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-300">
                        <i class="fas fa-user-circle mr-2 opacity-70"></i> Mon profil
                    </a>
        ...
        <aside class="hidden md:block w-64 bg-white dark:bg-gray-800 shadow-md h-screen fixed overflow-y-auto">
            <div class="p-5">
                ...
                <nav class="mt-6 space-y-1">
                    ...
                    <a href="#my-reservations" data-target="allRes" class="sidebar-link flex items-center px-4 py-3 text-base font-medium text-gray-600 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
