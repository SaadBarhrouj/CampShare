                ...
                <div class="flex flex-col md:flex-row items-start md:items-center">
                    ...
                    <div class="relative mb-6 md:mb-0 md:mr-8">
                        <div class="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-md">
                            <img src="{{ $userP->avatar_url ? asset($userP->avatar_url) : asset('images/item-default.jpg') }}"
                                 alt="Fatima Benali" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
                                    ...
                                    <span class="ml-3 text-sm font-medium px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-md">
                                        Partenaire depuis {{ $userP->created_at->translatedFormat('Y') }}
                                    </span>
                                </h1>
                                <div class="mt-2 flex items-center text-gray-600 dark:text-gray-300">
                                    <i class="fas fa-map-marker-alt mr-2 text-gray-400"></i>
                                    <span>{{ $userP->city->name }}, Maroc</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-6 flex-nowrap">
                            <div class="flex flex-col items-center">
                                @if($userP->receivedReviews->where('is_visible', true)->where('type', 'forPartner')->count() != 0 )
                                    <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ $userP->averageRatingPartner() }}</div>
                                    <div class="flex text-amber-400 mt-1">
                                        <x-star-rating :rating="$userP->averageRatingPartner()" />
                                    </div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">({{ $userP->receivedReviews->where('is_visible', true)->where('type', 'forPartner')->count() }} avis)</div>
                                @else
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex overflow-x-auto scrollbar-hide">
                    ...
                    <button id="tab-reviews1" class="px-4 py-4 font-medium text-lg text-gray-500 dark:text-gray-400 whitespace-nowrap">
                        Avis ( {{ $userP->receivedReviews->where('is_visible', true)->where('type', 'forPartner')->count() }} )
                    </button>
                </div>
            </div>
        </section>
        ...
        <section id="equipment-section1" class="py-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Équipements proposés par {{ $userP->username }}</h2>
                </div>
        ...
        <section id="reviews-section1" class="py-10 hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-8">
                        <div class="flex flex-col md:flex-row md:items-center">
                            <div class="flex flex-col items-center mr-8 mb-6 md:mb-0">
                                <div class="text-5xl font-bold text-gray-900 dark:text-white">{{ $userP->averageRatingPartner() }}</div>
                            ...
                            <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="flex-1 h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-amber-400 rounded-full" style="width: {{ $userP->fiveStarPercentagePartner(5) }}%"></div>
                                        </div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="flex-1 h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-amber-400 rounded-full" style="width: {{ $userP->fiveStarPercentagePartner(4) }}%"></div>
                                        </div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="flex-1 h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-amber-400 rounded-full" style="width: {{ $userP->fiveStarPercentagePartner(3) }}%"></div>
                                        </div>
                                ...
                                <div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="flex-1 h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-amber-400 rounded-full" style="width: {{ $userP->fiveStarPercentagePartner(2) }}%"></div>
                                        </div>
                                    ...
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="flex-1 h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-amber-400 rounded-full" style="width: {{ $userP->fiveStarPercentagePartner(1) }}%"></div>
                                        </div>
                ...
                <div class="space-y-6">
                    ...
                    @forelse ($userP->receivedReviews->where('is_visible', true)->where('type', 'forPartner') as $review)
