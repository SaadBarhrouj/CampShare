...
<body class="font-sans antialiased text-gray-800 dark:text-gray-200 bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300">
        ...
        <div class="bg-forest dark:bg-meadow text-white p-6">
            ...
            <div class="w-full bg-white/20 rounded-full h-2 mb-2">
                <div id="progress-bar" class="bg-sunlight h-2 rounded-full transition-all duration-500 ease-in-out" style="width: 33%"></div>
            </div>
            ...
            <div id="client-side-errors" class="hidden mb-6 p-4 bg-red-50 dark:bg-red-900/30 rounded-lg">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <ul id="client-error-list" class="mt-2 list-disc list-inside text-sm text-red-700 dark:text-red-300"></ul>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                <div class="flex">
                    ...
                    <div class="ml-3 text-sm text-blue-700 dark:text-blue-300">
                        Pour garantir la sécurité de notre communauté, nous demandons une vérification d'identité. Ces informations sont sécurisées et ne seront utilisées que pour valider votre identité.
                    </div>
                </div>
            </div>
            ...
            <form id="registration-form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <section id="step-1" class="step-section space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="username" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nom Complete *</label>
                    ...
                    <div>
                        <label for="phone_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Téléphone *</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                <i class="fas fa-phone"></i>
                            </div>
                            <input id="phone_number" name="phone_number" required value="{{ old('phone_number') }}"
                                class="w-full pl-10 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:border-forest focus:ring-2 focus:ring-forest/50 dark:bg-gray-700 dark:text-white transition"
                    ...
                    <div>
                        <label for="city_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Ville *</label>
                        <div class="relative">
                            <select id="city_id" name="city_id" required
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:border-forest focus:ring-2 focus:ring-forest/50 dark:bg-gray-700 dark:text-white transition">
                                <option value="" disabled {{ old('city_id') ? '' : 'selected' }}>-- Sélectionnez votre ville --</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Confirmation *</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                    <i class="fas fa-lock"></i>
                                </div>
                    ...
                    <div class="pt-4 flex justify-end">
                        <button type="button" id="next-to-step-2" class="flex items-center justify-center px-6 py-3 bg-forest hover:bg-forest/90 dark:bg-meadow dark:hover:bg-meadow/90 text-white rounded-lg font-medium transition">
                ...
                <section id="step-2" class="step-section hidden space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CIN Recto *</label>
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-forest dark:hover:border-meadow transition-colors">
                                <div class="text-center">
                                    <i class="fas fa-id-card text-3xl text-gray-400 mb-3"></i>
                                    <div class="flex text-sm text-gray-600 dark:text-gray-400 justify-center">
                                        <label class="relative cursor-pointer font-medium text-forest dark:text-meadow hover:text-opacity-80">
                                            <span>Télécharger</span>
                                            <input id="cin-front" name="cin_recto" type="file" accept="image/*" class="sr-only" required>
                                        </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CIN Verso *</label>
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-forest dark:hover:border-meadow transition-colors">
                                <div class="text-center">
                                    <i class="fas fa-id-card text-3xl text-gray-400 mb-3"></i>
                                    <div class="flex text-sm text-gray-600 dark:text-gray-400 justify-center">
                                        <label class="relative cursor-pointer font-medium text-forest dark:text-meadow hover:text-opacity-80">
                                            <span>Télécharger</span>
                                            <input id="cin-back" name="cin_verso" type="file" accept="image/*" class="sr-only" required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    ...
                    <div class="pt-4 flex justify-between">
                        <button type="button" id="back-to-step-1" class="flex items-center justify-center px-6 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg font-medium transition">
                            <i class="fas fa-arrow-left mr-2"></i> Précédent
                        </button>
                        <button type="button" id="next-to-step-3" class="flex items-center justify-center px-6 py-3 bg-forest hover:bg-forest/90 dark:bg-meadow dark:hover:bg-meadow/90 text-white rounded-lg font-medium transition">
                            Suivant <i class="fas fa-arrow-right ml-2"></i>
                        </button>
                    </div>
                </section>
    ...
    <div x-data="{ showTerms: false, showPrivacy: false, showContract: false }" class="space-y-4">
        ...
        <div x-show="showTerms" x-transition
            ...
            <ul class="list-disc pl-5 space-y-1">
                <li>L'utilisateur s'engage à respecter les conditions de location et d'utilisation du matériel.</li>
        ...
        <div x-show="showPrivacy" x-transition
            ...
            <ul class="list-disc pl-5 space-y-1">
                <li>Nous collectons uniquement les données nécessaires à la gestion de vos locations.</li>
        ...
        <button type="submit" id="register-btn"
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Déjà un compte ? <a href="{{ route('login') }}" class="text-forest dark:text-meadow font-medium hover:underline">Connectez-vous</a>
                    <span class="mx-2">•</span>
                    <a href="{{ url('/') }}" class="text-gray-600 dark:text-gray-400 hover:text-forest dark:hover:text-meadow hover:underline">Retour à l'accueil</a>
                </p>
            </div>
        </div>
    </div>
